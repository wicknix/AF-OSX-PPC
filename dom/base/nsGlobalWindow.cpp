                               ...
                               mozilla::ErrorResult& aError)
{
  ...
  nsAutoString _final;
  nsContentUtils::StripNullChars(aMessage, _final);
  ...
  if (ShouldPromptToBlockDialogs()) {
    ...
    aError = aAlert ?
               prompt->AlertCheck(title.get(), _final.get(), label.get(),
                                  &disallowDialog) :
               prompt->ConfirmCheck(title.get(), _final.get(), label.get(),
    ...
    aError = aAlert ?
               prompt->Alert(title.get(), _final.get()) :
               prompt->Confirm(title.get(), _final.get(), &result);
  }
