...
# from AuroraFox, modified for TenFourFox, and then ArcticFox
...
# fix Firefox and xpcshell
install_name_tool -change /opt/macports-tff/lib/gcc48/libstdc++.6.dylib @executable_path/libstdc++.6.dylib -change /opt/macports-tff/lib/gcc48/libgcc_s.1.dylib @executable_path/libgcc_s.1.dylib XUL
install_name_tool -change /opt/macports-tff/lib/gcc48/libstdc++.6.dylib @executable_path/libstdc++.6.dylib -change /opt/macports-tff/lib/gcc48/libgcc_s.1.dylib @executable_path/libgcc_s.1.dylib arcticfox
install_name_tool -change /opt/macports-tff/lib/gcc48/libstdc++.6.dylib @executable_path/libstdc++.6.dylib -change /opt/macports-tff/lib/gcc48/libgcc_s.1.dylib @executable_path/libgcc_s.1.dylib arcticfox-bin
install_name_tool -change /opt/macports-tff/lib/gcc48/libstdc++.6.dylib @executable_path/libstdc++.6.dylib -change /opt/macports-tff/lib/gcc48/libgcc_s.1.dylib @executable_path/libgcc_s.1.dylib libfreebl3.dylib
install_name_tool -change /opt/macports-tff/lib/gcc48/libstdc++.6.dylib @executable_path/libstdc++.6.dylib -change /opt/macports-tff/lib/gcc48/libgcc_s.1.dylib @executable_path/libgcc_s.1.dylib libmozalloc.dylib
install_name_tool -change /opt/macports-tff/lib/gcc48/libstdc++.6.dylib @executable_path/libstdc++.6.dylib -change /opt/macports-tff/lib/gcc48/libgcc_s.1.dylib @executable_path/libgcc_s.1.dylib libmozglue.dylib
install_name_tool -change /opt/macports-tff/lib/gcc48/libstdc++.6.dylib @executable_path/libstdc++.6.dylib -change /opt/macports-tff/lib/gcc48/libgcc_s.1.dylib @executable_path/libgcc_s.1.dylib libnss3.dylib
install_name_tool -change /opt/macports-tff/lib/gcc48/libstdc++.6.dylib @executable_path/libstdc++.6.dylib -change /opt/macports-tff/lib/gcc48/libgcc_s.1.dylib @executable_path/libgcc_s.1.dylib libnssckbi.dylib
install_name_tool -change /opt/macports-tff/lib/gcc48/libstdc++.6.dylib @executable_path/libstdc++.6.dylib -change /opt/macports-tff/lib/gcc48/libgcc_s.1.dylib @executable_path/libgcc_s.1.dylib libnssdbm3.dylib 
install_name_tool -change /opt/macports-tff/lib/gcc48/libstdc++.6.dylib @executable_path/libstdc++.6.dylib -change /opt/macports-tff/lib/gcc48/libgcc_s.1.dylib @executable_path/libgcc_s.1.dylib libplugin_child_interpose.dylib
install_name_tool -change /opt/macports-tff/lib/gcc48/libstdc++.6.dylib @executable_path/libstdc++.6.dylib -change /opt/macports-tff/lib/gcc48/libgcc_s.1.dylib @executable_path/libgcc_s.1.dylib libsoftokn3.dylib
install_name_tool -change /opt/macports-tff/lib/gcc48/libstdc++.6.dylib @executable_path/libstdc++.6.dylib -change /opt/macports-tff/lib/gcc48/libgcc_s.1.dylib @executable_path/libgcc_s.1.dylib updater.app/Contents/MacOS/updater
install_name_tool -change /opt/macports-tff/lib/gcc48/libstdc++.6.dylib @executable_path/../MacOS/libstdc++.6.dylib -change /opt/macports-tff/lib/gcc48/libgcc_s.1.dylib @executable_path/../MacOS/libgcc_s.1.dylib ../Resources/webapprt-stub
install_name_tool -change /opt/macports-tff/lib/gcc48/libstdc++.6.dylib @executable_path/../../../MacOS/libstdc++.6.dylib -change /opt/macports-tff/lib/gcc48/libgcc_s.1.dylib @executable_path/../../../MacOS/libgcc_s.1.dylib ../Resources/browser/components/libbrowsercomps.dylib
