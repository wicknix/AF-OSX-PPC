...
/*
// Until issue 266 is fixed, this will need to be disabled. See below for
// patches to use .toLocaleString() instead.
  ...
  getCellText : function(row,column) {
    ...
    switch (column.id) {
      ...
      case "timeCreatedCol":
        ...
        return time.toLocaleString(); //dateFormatter.format(time);
      case "timeLastUsedCol":
        time = new Date(signon.timeLastUsed);
        return time.toLocaleString(); //dateAndTimeFormatter.format(time);
