...
pref("extensions.getAddons.get.url", "http://macintoshgarden.org/apps/arctic-fox-web-browser");
pref("extensions.getAddons.getWithPerformance.url", "http://macintoshgarden.org/apps/arctic-fox-web-browser");
...
pref("browser.getdevtools.url","http://macintoshgarden.org/apps/arctic-fox-web-browser");

// Feedback URL
pref("browser.feedback.url", "http://macintoshgarden.org/apps/arctic-fox-web-browser");
...
pref("app.support.baseURL", "http://macintoshgarden.org/apps/arctic-fox-web-browser");
...
pref("dom.ipc.plugins.enabled.x86_64", false);
#else
...
pref("status4evar.status.linkOver", 3);
...
pref("general.useragent.override.youtube.com", "Mozilla/5.0 (Mobile; rv:38.0) Gecko/38.0 KaiOS/2.0");